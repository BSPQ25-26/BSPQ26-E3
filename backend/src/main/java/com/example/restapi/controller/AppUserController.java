...
public class AppUserController {
    ...
    public ResponseEntity<Profile> updatePartOfUser(@RequestBody Map<String, Object> updates, @PathVariable UUID id){
        try {
            return ResponseEntity.ok(appUserService.updatePartOfUser(id, updates));
        } catch (RuntimeException e) {
            return ResponseEntity.notFound().build();
        }
    }
